...
difficulty = input("Elige el nivel de dificultad (1: Fácil, 2: Medio, 3: Difícil): ")

# Velocidad de la paleta del jugador 1 basado en la dificultad
...
while True:
    ...
    # Movimiento automático de la paleta del jugador 1
